...
typedef CustomDataColumnSortCallback = void Function(
...
/// in the [CustomDataTable], in the [new DataRow] constructor's `cells`
/// argument.
@immutable
class CustomDataCell {
  ...
  static final CustomDataCell empty =
      CustomDataCell(Container(width: 0.0, height: 0.0));
...
abstract class CustomDataTableSource extends ChangeNotifier {
